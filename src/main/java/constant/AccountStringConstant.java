 ...
 */
/**
 * This class is used to define some Account String Constant
 *
 * @author Nguyễn Duy Phúc
 */
public class AccountStringConstant {

    // Tên các labeL và title trong UI
    ...
    public static final String ACCOUNT_NEW_PWD = "Mật khẩu mới";
    public static final String ACCOUNT_RE_NEW_PWD = "Xác thực mật khẩu mới";
    ...
    public static final String ACCOUNT_INPUT_NAME = "Nhập chủ tài khoản";
    public static final String ACCOUNT_INPUT_USERNAME = "Nhập tài khoản";
    ...
    public static final String ACCOUNT_ERROR_NEW_PWD = "Vui lòng nhập mật khẩu mới";
    public static final String ACCOUNT_ERROR_RE_NEW_PWD = "Vui lòng nhập xác thực mật khẩu mới";
    ...
    public static final String ACCOUNT_ERROR_INCORRECT_PWD = "Mật khẩu cũ không đúng";
    ...
    public static final String ACCOUNT_RECOVER_SUCCESS = "Khôi phục tài khoản thành công. Mật khẩu mặc định là: 123456";
    public static final String ACCOUNT_CREATE_FAIL = "Thêm tài khoản thất bại";
    public static final String ACCOUNT_UPDATE_FAIL = "Cập nhật tài khoản thất bại";
    public static final String ACCOUNT_DELETE_FAIL = "Xóa tài khoản thất bại";
    public static final String ACCOUNT_RECOVER_FAIL = "Khôi phục tài khoản thất bại";
}
